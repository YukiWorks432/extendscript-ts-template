...
ユーザーがコードを貼り付けていない場合は、対象ファイルを読み込む。
...
三項演算子が見つかった場合は、利用可能な質問ツールまたは簡潔な日本語の質問でユーザーに確認する:
...
ユーザーが指定していない場合は、利用可能な質問ツールまたは簡潔な日本語の質問で確認する:
...
`.agents/instructions/extendscript.md` を読み、コーディングルールを確認してから変換する。
